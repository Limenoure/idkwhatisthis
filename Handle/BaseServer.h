...
public:
	...
	int AutoFarm_Delay = 0, Dq_Day = 0, Dq_Item1 = 0, Dq_Item2 = 0, Dq_Count1 = 0, Dq_Count2 = 0, ItemsDat_Hash = 0, ItemsDat_Size = 0, Stock_Mag = 0, Stock_GRay = 0, Stock_ERay = 0, Server_Port = 0, Enter_Count = 0, Restart_Time = 1, janeway_payout = 0;
	...
	std::string apikey_ai = "", server_name = "", GT_Version = "", server_version = "", discord_url = "", osm_link = "", osm_path = "", proto = "", website_url = "", server_ip = "", zombie_list = "", surgery_list = "", wolf_list = "", whatsapp_url = "", Active_World_List, List_World_Menu, Sb_World, Sdb_World, Deposit_World;
